...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return org.springframework.security.core.userdetails.User // 스프링 시큐리티에서 제공하는 UserDeatail 구현체
...
// 로그인 시도 -> 스프링이 낚아챔 -> (현재 클래스에서) 일단 유저 엔티티로 담아온다음 UserDetails 형태로 옮겨 담아서 가져감.
